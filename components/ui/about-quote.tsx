          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-3 md:space-y-4">
              <p className="text-sm md:text-base lg:text-lg xl:text-xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
                Sou estudante de Engenharia de Software e desenvolvedor Back-end, focado em construir sistemas robustos e escaláveis. Tenho foco em Java, APIs RESTful e bancos de dados relacionais, sempre buscando escrever código limpo e bem estruturado.
              </p>
              <p className="text-sm md:text-base lg:text-lg xl:text-xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
